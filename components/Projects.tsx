...
const cardImages = [
  '/images/building-corridor.jpg', // Project 1 — Construction
  '/images/office-corridor.jpg',   // Project 2 — Maintenance
  '/images/bathroom-sauna.jpg',    // Project 3 — Renovation
  '/images/house-exterior.jpg',    // Project 4 — Outdoor
] as const
        ...
        {cards.map(({ id, tagKey, titleKey, locKey, delay }, i) => (
          <RevealOnScroll key={tagKey} delay={delay}>
            ...
            >
              ...
              <div className="absolute inset-0 transition-transform duration-[700ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-[1.04]">
                <Image src={cardImages[i]} alt="" fill className="object-cover object-center" />
              </div>
              {/* Gradient overlay */}
              <div
                ...
                style={{
                  background:
                    'linear-gradient(to top, rgba(12,11,9,0.95) 0%, rgba(12,11,9,0.4) 50%, rgba(12,11,9,0.05) 100%)',
                }}
              />
              {/* Text */}
